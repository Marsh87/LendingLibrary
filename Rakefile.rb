...
#task :build => [:just_build, :test, :test_web]
...
task :build_with_cover => [:just_build, :test_with_nunit_coverage] 
...
task :build_with_sonar => [:just_build, :test_with_nunit_coverage, :sonar]
#---------------------------------Update stuff---------------------------------
...
dotcover :test_with_nunit_coverage do |dc|
    ...
    dc.filters '+:module=*;class=*;function=*;-:*.Tests;-:*.Tests.Common;-:AutoMapper;-:AutoMapper.*;-:RetailStudio.*'
end
#---------------------------------Run Web Tests--------------------------------
